...
internal enum Asset {
  internal enum Colors {
    internal static let gradientBlueDark = ColorAsset(name: "gradientBlueDark")
    ...
    internal static let gradientTarquoiseLight = ColorAsset(name: "gradientTarquoiseLight")
